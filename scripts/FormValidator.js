export class FormValidator {
    ...
    _setEventListeners(formElement) {
      this.inputElements = Array.from(formElement.querySelectorAll(this.obj.inputSelector));
      this.buttonElement = formElement.querySelector(this.obj.submitButtonSelector);

      this.inputElements.forEach((input) => {
        input.addEventListener("input", (evt) => {
          console.log(formElement);
          this._checkInputValidity(formElement, evt.target);
          this._toggleButttonState(formElement, this.buttonElement, this.obj.inactiveButtonClass);         //////// this.obj.
        });
      });
        this._toggleButttonState(formElement, this.buttonElement, this.obj.inactiveButtonClass);          ///////// this.obj.
    }
